...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-1 sm:space-x-2 z-20">
          ...
          <button
            ...
            className={`rounded-full transition-all duration-300 ${
              index === currentImageIndex
                ? "bg-white scale-125 w-1 h-1 sm:w-3 sm:h-3"
                : "bg-white/50 hover:bg-white/70 w-0.5 h-0.5 sm:w-2.5 sm:h-2.5"
            }`}
